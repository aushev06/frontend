    ...
    return (
        <div className={styles.userCard}>
            ...
            <div className={styles.userCard_section}>
                 <div className={styles.userCard_articles}>
                    <span>Статьи <b>24</b></span>
                    <svg onClick={() => toggleLeak()} className={leak ? styles.rotated : ''} width="9" height="6" viewBox="0 0 9 6" fill="none" xmlns="http://www.w3.org/2000/svg">
