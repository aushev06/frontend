        ...
        <div className="wrapper">
          {!mq.isXS && (
            <div className="left-side">
              ...
              <SideBlock name="Темы">
                <Tags items={themes} handleSelect={handleSelectTheme} selectedItems={selectedThemes} />
              </SideBlock>
            </div>
          )}
          ...
          <div className={clsx('content', mq.isXS ? 'm-0' : '')}>
            ...
            {!isLoading && showPosts && page !== maxPage && <LoadMore onClick={() => setPage(page + 1)} />}
          </div>
          {!mq.isXS && (
